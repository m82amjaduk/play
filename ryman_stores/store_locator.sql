...
CREATE TABLE `storelocator_branches` (
  ...
  `map_zoom_list_page` INT(11) NULL DEFAULT '16',
  `map_zoom_branch_page` INT(11) NULL DEFAULT '16',
  `map_branch_img` VARCHAR(256) NULL DEFAULT NULL,

  `banner` TEXT NULL,
  `branch_title` VARCHAR(256) NULL DEFAULT NULL,
  `branch_description` TEXT NULL,
  `location_title` VARCHAR(256) NULL DEFAULT NULL,
  `location_description` TEXT NULL,
  `near_us_title` VARCHAR(256) NULL DEFAULT NULL,
  `near_us_description` TEXT NULL,
  `aside_img` TEXT NULL,
  `is_store_delivery` TINYINT(4) NOT NULL DEFAULT '0',
  `delivery_note` TEXT ,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `branch_code` (`branch_code`),
