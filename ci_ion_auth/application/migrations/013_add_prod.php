    ...
    public function up()
    {
        ...
        $this->db->query(
            "CREATE TABLE IF NOT EXISTS  `prod_list` (
              ...
              `vat` decimal(7,2) NOT NULL DEFAULT '-2',
              `instruction` text,
              `default_note` text,
              ...
              `now_price` decimal(7,2) NOT NULL DEFAULT '-2' COMMENT 'If it is on discounted price, new price here',
              PRIMARY KEY (`id`)
        ...
        $this->db->query(
            ...
            LEFT JOIN prod_list ON prod_list.id =  prod_meat_price.prod_list_id
        ...
        $this->db->query("DROP FUNCTION IF EXISTS `prod_option_user_view`;");
        $this->db->query(
            "CREATE FUNCTION prod_option_user_view(option_name CHAR(250), price CHAR(250))
            RETURNS CHAR(250)
            BEGIN
        ...
        $this->db->query("DROP VIEW IF EXISTS `prod_options_price_view`;");
        $this->db->query(
            ...
            SELECT
                ...
                prod_list.prod_category_id,
                prod_option_user_view(prod_options.name_option, prod_options_price.price) as user_view
