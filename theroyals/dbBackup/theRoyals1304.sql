...
CREATE TABLE `prod_list` (
  ...
  `vat` decimal(2,2) NOT NULL DEFAULT '-0.99',
  `instruction` text,
  `default_note` text,
...
INSERT INTO `prod_list` VALUES (1,1,'2014-04-13 01:24:57',1,1,'New','#','#','ddwsw',0.99,1,-0.99,'fsdf','dfsd',0,0,'#'),(2,1,'2014-04-13 00:24:57',1,1,'New','#','#','ddwsw',0.99,1,-0.99,'fsdf','dfsd',0,0,'#'),(3,1,'2014-04-13 00:24:57',1,1,'New','#','#','ddwsw',0.99,1,-0.99,'fsdf','dfsd',0,0,'#'),(4,1,'2014-04-13 00:24:57',1,1,'New','#','#','ddwsw',0.99,1,-0.99,'fsdf','dfsd',0,0,'#');
...
-- Dump completed on 2014-04-13  2:28:01
